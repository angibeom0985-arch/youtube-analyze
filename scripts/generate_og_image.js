...
// 한글 폰트 등록
try {
  registerFont('C:/Windows/Fonts/malgunbd.ttf', { family: 'Malgun Gothic Bold' });
...
function createOgImage(outputPath, title, subtitle, colors, width, height) {
  ...
  ctx.font = `bold ${Math.floor(85 * scale)}px "Malgun Gothic Bold", "Malgun Gothic", sans-serif`;
  ctx.fillStyle = '#ffffff';
...
createOgImage(
  ...
  { start: '#8B0000', end: '#DC143C', accent: '#FF6B6B', domainText: '#8B0000' },
  1200, 630
);
...
createOgImage(
  ...
  '사용법 가이드',
  'AI 영상 분석 도구 완벽 사용법',
  { start: '#003366', end: '#0066CC', accent: '#4A9EFF', domainText: '#003366' },
  1200, 630
);
...
createOgImage(
  ...
  { start: '#4B0082', end: '#8A2BE2', accent: '#BA55D3', domainText: '#4B0082' },
  1200, 630
);
